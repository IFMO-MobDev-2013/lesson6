    ...
    class TagHandler extends DefaultHandler {
        ...
        public void characters(char[] ch, int start, int length) throws SAXException {
            if (tags.size() > 0) {
                ...
                RSSNode target = isItem ? currentItem : currentChannel;
                if (target != null) {
...
class RSSItem extends RSSNode implements Serializable {
...
class RSSChannel extends RSSNode implements Serializable {
}
